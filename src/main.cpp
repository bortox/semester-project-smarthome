...
// MENU_SCREEN(lightmovementScreen,lightmovementItems),
//     ITEM_DYNAMIC("Light:", photoresistorCallback),
//     ITEM_DYNAMIC("Movement", movementCallback)
// );
...
void loop() {
    keyboard.observe();
    // This should update only if we are in a temperature/light state menu
    menu.poll();
